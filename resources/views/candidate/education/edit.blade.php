...
@section('content')
    ...
    <div class="row">
        <div class="col-xl-7 mx-auto">
            <h6 class="mb-0 text-uppercase">Edit Education</h6>
            <hr>
            <div class="card border-top border-0 border-4 border-primary">
                <div class="card-body p-5">
                    ...
                    <form class="row g-3" method="POST" action="{{ route('education.update',$item->id) }}"
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" name="passing_year" class="form-control" id="passing_year"
                                value="{{ old('passing_year', $item->passing_year) }}"
                                placeholder="Enter Passing/Trainig Year">
                        </div>
                        <div class="col-md-12">
                            <label for="cgpa" class="form-label">CGPA / GPA*</label>
                            <input type="text" name="cgpa" class="form-control" id="cgpa"
                                value="{{ old('cgpa', $item->cgpa) }}" placeholder="Enter CGPA/GPA">
                        </div>
