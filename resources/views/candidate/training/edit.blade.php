...
@section('content')
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Edit Trainig</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-xl-7 mx-auto">
            <h6 class="mb-0 text-uppercase">Edit Trainig</h6>
            <hr>
            <div class="card border-top border-0 border-4 border-primary">
                <div class="card-body p-5">
                    ...
                    <form class="row g-3" method="POST" action="{{ route('trainings.update',$item->id) }}"
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" name="training_name" placeholder="Enter Trainig Name" class="form-control"
                                id="name" value="{{ old('name',$item->training_name) }}">
                        </div>
                        <div class="col-md-12">
                            <label for="institute_name" class="form-label">Institute Name*</label>
                            <input type="text" name="institute_name" placeholder="Enter Institute Name"
                                class="form-control" id="institute_name" value="{{ old('institute_name',$item->institute_name) }}">
                        </div>
                        <div class="col-md-12">
                            ...
                            <input type="text" name="passing_year" class="form-control" id="passing_year"
                                value="{{ $item->passing_year }}" placeholder="Enter Passing/Trainig Year">
                        </div>
                        <div class="col-12">
